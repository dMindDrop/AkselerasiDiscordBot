...
class BiWeeklyTest(commands.Cog):
    ...
    async def mark_bi_weekly_test(self, ctx, sequence_number: int):
        ...
        await temp_channel.send(f"{ctx.author.mention}, Silahkan lanjutkan proses tes dua mingguan di sini.")
        ...
        # Confirmation logic
        confirm_message = f"Apakah Anda ingin menyimpan jawaban untuk Putaran {sequence_number}?"
        ...
        class ConfirmationView(nextcord.ui.View):
            ...
            @nextcord.ui.button(label='Ya', style=nextcord.ButtonStyle.success)
